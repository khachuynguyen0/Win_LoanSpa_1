...
namespace L2_DLL
{
    ...
    public class Manager_tab_NH_1
    {
        ...
        public DataTable Get_MaNH_MoiNhat_GetDataTable()
        {
            //BD
            string truyVan = "select max(a.maNH) as maNH\r\n" +
                "from NHAPHANG a";
        ...
        //TC: true
        //inp: a.maHD
        public bool Them1_DT(decimal tongTien, int trangThai, int maDT)
        {
            //BD

            bool succ = true;
            //1.truy van
            string truyVan = "insert into NHAPHANG(tongTien, trangThai, maNCC) values("+tongTien+", " +
                ""+trangThai+", "+maDT+");";
