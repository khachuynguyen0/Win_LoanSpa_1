...
namespace L2_DLL
{
    ...
    public class Manager_tab_DV_1
    {
        ...
        public DataTable Get_MaDV_From_ShowTenDV_GetDataTable(string tenDV)
        {
            //BD
            string truyVan = "select distinct a.maDV\r\n" +
                "from DICHVU a\r\n" +
        ...
        public int Get_MaDV_From_ShowTenDV_GetInt(string tenDV)
        {
            //BD
            int maDV = -1;
            DataTable dt_temp_1 = new DataTable();
            dt_temp_1 = Get_MaDV_From_ShowTenDV_GetDataTable(tenDV);

            maDV = Convert.ToInt32(dt_temp_1.Rows[0]["maDV"]);
        ...
        // public int Get_MaHH_From_ShowTenHH_GetInt
