...
namespace L2_DLL
{
    ...
    public class Manager_CTHD_HOADON_DICHVU_1
    {
        ...
        //TC: true
        //inp: a.maHD, b.maDV
        public bool Them1_DT(int maHD, int maDV, decimal soLuong, decimal donGia)
        {
            //BD

            bool succ = true;
            //1.truy van
            string truyVan = "insert into CTHD_HOADON_DICHVU( maHD, maDV, soLuong, donGia) " +
                "values("+maHD+", "+maDV+", "+soLuong+","+donGia+");";
